...
echo "  export API_SERVER_URL=http://vllm-direct.llm-d-bench.svc.cluster.local:8000"
echo "  # Alternative: EPP endpoint: http://optimized-baseline-epp.llm-d-bench.svc.cluster.local:80"
echo "  # Alternative: Gateway endpoint: http://llm-d-inference-gateway.llm-d-bench.svc.cluster.local:80"
